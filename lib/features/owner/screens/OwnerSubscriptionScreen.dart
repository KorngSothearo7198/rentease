...
class _OwnerSubscriptionScreenState extends State<OwnerSubscriptionScreen> {
  ...
  final List<Map<String, dynamic>> _banks = [
    ...
    },
    {
      ...
      'account': '0002-9876-5432',
    },
    {
      'id': 'wing',
      'name': 'Wing Bank',
      'color': Color(0xFFE31C23),
      'account': '0003-1122-3344',
    },
  ];
    ...
    return StreamBuilder<List<SubscriptionModel>>(
      ...
      builder: (context, subscriptionSnapshot) {
        ...
        return StreamBuilder<List<SubscriptionPlanModel>>(
          stream: _plansService.subscriptionPlans(),
          builder: (context, planSnapshot) {
            ...
            final selectedIndex =
            _selectedPlanIndex < plans.length ? _selectedPlanIndex : 0;
  ...
  Widget _buildSubscribeButton({
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          pendingSub != null ? 'Approval Pending' : 'Subscribe Now',
          style: const TextStyle(
            fontSize: 16,
  ...
  Widget _buildActiveStatusCard(SubscriptionModel sub) {
  ...
  Widget _buildPendingStatusCard(SubscriptionModel sub) {
    return Container(
      width: double.infinity,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Your request for ${sub.planName} is under review.',
                  style: const TextStyle(
  ...
  Widget _buildPlanCard({
    ...
    final bool isRecommended = plan.recommended;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  '${plan.currency == 'USD' ? '\$' : plan.currency}${plan.price.toStringAsFixed(0)}',
                  style: const TextStyle(
                    fontSize: 30,
                    fontWeight: FontWeight.w800,
                    color: textColor,
  ...
  void _openCheckoutModal(SubscriptionPlanModel plan) {
                ...
                const Duration(seconds: 1),
                  ...
                  if (countdown <= 1) {
                    ...
                    _submitPayment(
                      plan: plan,
                      bankName:
                      _banks[selectedBankIndex]['name'].toString(),
                    );
                  } else {
                    setModalState(() {
                      countdown--;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed:
                          isProcessing ? null : startAutoPayment,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: primaryColor,
                      ...
                      if (!isProcessing)
                        Center(
                          child: Text(
                            'Payment request will be submitted after 5 seconds.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 12,
                              color: secondaryTextColor
  ...
  Widget _buildPlanSummary(SubscriptionPlanModel plan) {
    return Container(
  ...
  Widget _buildQrPaymentSection({
    ...
    final Color bankColor = bank['color'] as Color;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Amount: ${plan.currency == 'USD' ? '\$' : plan.currency}${plan.price.toStringAsFixed(2)}',
            style: const TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w800,
              color: primaryColor,
  ...
  Future<void> _submitPayment({
    ...
    try {
      final hasPending =
      await _subscriptionService.hasPendingSubscription(
        _ownerId!,
      );
...
class _SubscriptionSubmittedDialog extends StatefulWidget {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                const Text(
                  'Your payment request has been submitted successfully. Your subscription is now pending admin approval.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 15,
                    height: 1.5,
